                        ...
                        @if (!is_null($content))
                            <div class="text-center my-5">
                                ...
                                <div class="d-flex justify-content-center fs-2 gap-4">
                                    <a class="text-gradient" href="https://www.tiktok.com/@ladabubuk968?_t=8ngkaZiwtN9&_r=1"><i class="bi bi-tiktok"></i></a>
                                    <a class="text-gradient" href="https://github.com/"><i class="bi bi-github"></i></a>
                                    <a class="text-gradient" href="https://www.instagram.com/cocalllyann?igsh=MWtudHhseWZwcmszaA=="><i class="bi bi-instagram"></i></a>
                                    <a class="text-gradient" href="https://www.facebook.com/maria.cochalyana"><i class="bi bi-facebook"></i></a>
                                </div>
                            </div>
                        @else
                            <div class="text-center my-5">
    ...
    <footer class="bg-white py-4 mt-auto">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="col-auto">
                    <span>Copyright &copy; <a href="https://github.com/" target="_blank">Github</a> {{ now()->year }}</span>
                </div>
                <div class="col-auto">
